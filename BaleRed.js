...
// user_id        : user_id
// user_hash      : user_hash
// effective_msg : effective msg
// content : message content
//     function BaleReplyNode(config) {
//         RED.nodes.createNode(this, config);
//         var node = this;
//         this.bot = config.bot;
//
...
//                     if (msg.payload) {
//
//                         var message = msg.payload.caption;
//
//                         node.baleBot.reply(message).then(function (botMsg) {
//
...
//     }
//
//     RED.nodes.registerType("bale reply", BaleReplyNode);
//
};